...
│                           │          │                            │
│  ТОЛЬКО пользоват. I/O:   │          │  ТОЛЬКО внутреннее:        │
│    [alice] > привет       │          │    СИСТЕМНЫЙ ПРОМПТ (весь) │
│                           │  пишет   │    СКИЛЛЫ + ПАМЯТЬ         │
│    Привет! Чем могу       │ ──────>  │    СЫРОЙ ОТВЕТ LLM (tools) │
│    помочь?                │ trace    │    ВЫЗОВ + РЕЗУЛЬТАТ       │
│                           │ .jsonl   │    СОСТОЯНИЕ АГЕНТА        │
│  Никакого отладочного     │          │    ГАРДРЕЙЛ [ЗАПРЕТ]       │
│  шума.                    │          │                            │
│                           │          │  Ввод/ответ скрыты:        │
│                           │          │    > [12 симв. — см. Т1]   │
└───────────────────────────┘          └────────────────────────────┘
Информация не дублируется между терминалами.
```
